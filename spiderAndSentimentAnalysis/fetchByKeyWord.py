...
def startSpider(arg1, arg2, arg3, arg4):
    # arguments control
    # if len(sys.argv) != 5:
    #     print('args error')
    #     exit()
    ...
    TablePostName = TablePostPrefix+module_id
    TableCommentName = TableCommentPrefix+module_id
    # create table by mid
    ...
    for page in range(1, 1000):
        ...
        jsonData = get_posts(page, type+theme)
